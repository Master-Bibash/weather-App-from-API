...
class Constants {
  ...
  final Shader shader = const LinearGradient(
    colors: <Color>[Color(0xddABCFF2), Color(0xff9AC6F3)],
  ).createShader(Rect.fromLTWH(0.0, 0.0, 200, 70));

  final LinearGradient linearGradient1 = const LinearGradient(
  ...
  final LinearGradient linearGradient2 = const LinearGradient(
    begin: Alignment.bottomRight,
    end: Alignment.topLeft,
